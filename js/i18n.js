...
const STRINGS = {
  tw: {
    ...
    pinTitle: '標定目前目標（永久保存在此裝置）',
    pinClearTitle: '清空所有標定點',
    pinClearOk: '全部清空',
    confirmClearPins: '確定要刪除全部 {n} 個標定點？此動作無法復原。',
    errNothingToPin: '目前沒有可標定的目標，請先完成定位',
    distTitle: '此測站到目標的距離',
    namePlaceholder: '名稱',
    nameTitle: '名稱（選填）',
  ...
  en: {
    ...
    pinTitle: 'Save current target (kept on this device)',
    pinClearTitle: 'Clear all saved targets',
    pinClearOk: 'Clear all',
    confirmClearPins: 'Delete all {n} saved targets? This cannot be undone.',
    errNothingToPin: 'No target to save yet — complete a fix first',
